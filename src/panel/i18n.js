...
export const EN = {
  ...
  'panel.docBar': '🗒 About this document',
  ...
  'pane.placeholder': 'Comment… (⌘/Ctrl+Enter to save)',
  'pane.save': 'Save', 'pane.cancel': 'Cancel', 'pane.emojiOnly': '(reaction only)',
  'pane.send': 'Send', 'pane.pending': 'sent — awaiting reply…',
...
export const JA = {
  ...
  'pane.placeholder': 'コメント…(⌘/Ctrl+Enter で保存)',
  'pane.save': '保存', 'pane.cancel': '閉じる', 'pane.emojiOnly': '(絵文字のみ)',
  'pane.send': '送信', 'pane.pending': '送信済 — 応答待ち…',
  'menu.delete': '🗑 アンカーを削除',
